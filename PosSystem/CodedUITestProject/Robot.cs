...
namespace CodedUITestProject
{
    public class Robot
    {
        ...
        public static void AssertDataGridViewByIndex(string name, int index, string[] data)
        {
            WinTable table = (WinTable)Robot.FindWinControl(typeof(WinTable), name, _root);
            WinRow _Winrow = new WinRow(table);
            _Winrow.SearchProperties.Add(WinRow.PropertyNames.RowIndex, index.ToString());
            _Winrow.Find();
        ...
        public static void AssertEditEnable(string name, bool enabled)
        {
            WinEdit edit = (WinEdit)Robot.FindWinControl(typeof(WinEdit), name, _root);
            Assert.AreEqual(edit.Enabled, enabled);
        }

        public static void AssertComboEnable(string name, bool enabled)
        {
            WinComboBox combo = (WinComboBox)Robot.FindWinControl(typeof(WinComboBox), name, _root);
            Assert.AreEqual(combo.Enabled, enabled);
        }
